...
                target="*blank"
                rel="noopener noreferrer"
                className="group block text-center transition-all duration-700 hover:scale-[1.04] hover:-translate-y-6 hover:shadow-[0_40px_80px*-20px_rgb(59,130,246)]"
              >
...
                target="*blank"
                rel="noopener noreferrer"
                className="group block text-center transition-all duration-700 hover:scale-[1.04] hover:-translate-y-6 hover:shadow-[0_40px_80px*-20px_rgb(248,113,113)]"
              >
